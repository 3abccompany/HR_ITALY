...
export const MVP_PERMISSIONS: PermissionDefinition[] = [
  ...
  { code: "worksites.read", module: "worksites", action: "read", label: "Voir les sites", description: "Liste des lieux de travail de l'entreprise.", scope: "entity" },
  { code: "worksites.create", module: "worksites", action: "create", label: "Créer un site", description: "Ajouter un nouveau lieu de travail.", scope: "entity" },
  { code: "worksites.update", module: "worksites", action: "update", label: "Modifier un site", description: "Mise à jour d'un lieu de travail.", scope: "entity" },
  { code: "worksites.archive", module: "worksites", action: "archive", label: "Archiver un site", description: "Désactiver un lieu de travail.", scope: "entity" },
